...
double real_dis_x = 0.0;
double real_dis_y = 0.0;
...
static void Display_Main_Menu(void)
{
	...
	printf("| [18] Disarm the Drone         | [37] Enter Mobile commands mode  |\n");
    	printf("| [19] Virtual RC Test          | [38] test			   | \n");
    printf("+-----------------------------------------------------------------+\n");
...
void getmessage(const std_msgs::String::ConstPtr& msg)  
{
	...
	ss >>real_dis_x>>real_dis_y;

	cout<<real_dis_x<<" "<<real_dis_y<<endl;
}  
...
int main(int argc, char *argv[])
{
    ...
    {
	printf("1\n");
	ros::Subscriber sub = nh.subscribe("real_distance", 1000, getmessage);
        ros::spin();
